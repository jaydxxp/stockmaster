    ...
    <div className="">
      ...
      <div className="border border-black/10 rounded-2xl p-6 bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <div>
            <label className="text-sm text-gray-700">Receive From</label>
            <input
              type="text"
              placeholder="Supplier or Source Warehouse"
              className="
        ...
        <button
          ...
          className="
            mt-4 border border-black text-black px-4 py-2 rounded-lg 
